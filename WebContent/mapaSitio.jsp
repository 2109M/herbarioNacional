                ...
                <div class="col-12 col-md-4">
                    <ul class="SiteMap-list">
                        <li class="SiteMap-item">
                            <a class="SiteMap-link" href="#"><i class="fas fa-home"></i>Inicio</a>
                        </li>
                        <li class="SiteMap-item">
                            <a class="SiteMap-link" href="#"><i class="fas fa-flag"></i>Misión</a>
                        </li>
                        <li class="SiteMap-item">
                            <a class="SiteMap-link" href="#"><i class="fas fa-eye"></i>Visión</a>
                        </li>
                    </ul>
                </div>
                <div class="col-12 col-md-4">
                    <ul class="SiteMap-list">
                        <li class="SiteMap-item">
                            <a class="SiteMap-link" href="#"><i class="fas fa-bullhorn"></i>Anuncios</a>
                        </li>
                        <li class="SiteMap-item">
                            <a class="SiteMap-link" href="#"><i class="fas fa-calendar"></i></i>Eventos</a>
                        </li>
                        <li class="SiteMap-item">
                            <a class="SiteMap-link" href="#"><i class="far fa-newspaper"></i>Noticias</a>
                        </li>
                    </ul>
                </div>
                <div class="col-12 col-md-4">
                    <ul class="SiteMap-list">
                        <li class="SiteMap-item">
                            <a class="SiteMap-link" href="#"><i class="fas fa-cogs"></i>Servicios</a>
                        </li>
                        <li class="SiteMap-item">
                            <a class="SiteMap-link" href="#"><i class="fas fa-graduation-cap"></i>Cursos</a>
                        </li>
                        <li class="SiteMap-item">
                            <a class="SiteMap-link" href="#"><i class="fas fa-medal"></i>Certificación de muestra</a>
                        </li>
                    </ul>
                </div>
                <div class="col-12 col-md-4">
                    <ul class="SiteMap-list">
                        <li class="SiteMap-item">
                            <a class="SiteMap-link" href="#"><i class="fas fa-plus-square"></i>Suscripción</a>
                        </li>
                    </ul>
                </div>
                <div class="col-12 col-md-4">
                    <ul class="SiteMap-list">
                        <li class="SiteMap-item">
                            <a class="SiteMap-link" href="#"><i class="fas fa-leaf"></i>Muestra</a>
                        </li>
                    </ul>
                </div>
                <div class="col-12 col-md-4">
                    <ul class="SiteMap-list">
                        <li class="SiteMap-item">
                            <a class="SiteMap-link" href="#"><i class="fas fa-address-card"></i>Contacto</a>
                        </li>
                    </ul>
                </div>
                <div class="col-12 col-md-4">
                    <ul class="SiteMap-list">
                        <li class="SiteMap-item">
                            <a class="SiteMap-link" href="#"><i class="fas fa-map"></i>Mapa del sitio</a>
                        </li>
                    </ul>
                </div>
            </div>
